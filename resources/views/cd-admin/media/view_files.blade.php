    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
         ...
         <a href="{{url('/add_files')}}"><button type="button" class="btn bg-gradient-primary float-sm-right">Add File</button></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <p><b>File Title:</b>&nbsp;File title will be here</p><br>
                <p><b>File :</b>&nbsp;File  will be here</p><br>
                <p><b>File Alternative Description:</b>&nbsp;File Alternative Description will be here</p><br>
                <p><b>File View:</b>&nbsp;Views count will be here</p><br>
                <p><b>File Description:</b>&nbsp;File  Description will be here</p><br>
                <p><b>File Summary:</b>&nbsp;File  Summary will be here</p><br>
