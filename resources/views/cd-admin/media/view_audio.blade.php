        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <p><b>Audio Title:</b>&nbsp;Audio title will be here</p><br>
                <p><b>Audio Link:</b>&nbsp;Audio url will be here</p><br>
                <p><b>Audio View:</b>&nbsp;Views count will be here</p><br>
                <p><b>Audio Description:</b>&nbsp;Audio  Description will be here</p><br>
