...
<section class="content">
	<div class="row"> 
     ...
     <div class="card card-info">
      ...
      <div class="card-body">
        <form action="{{url('store_audio')}}" method="post" enctype="multipart/form-data">
         @csrf
         ...
         <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Enter Audio Title" name="audiotitle" value="{{old('audiotitle')}}">
      ...
      <div class="form-group">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="Enter Audio Url" name="audiourl" value="{{old('audiourl')}}">
        ...
        <div class="form-group">
         ...
         style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('audiodescription')}}</textarea>
       ...
       <div class="form-group">
        ...
        <div class="input-group mb-3">
          ...
          <textarea class="form-control" rows="6" placeholder="Enter Audio Summary " name="audiosummary">{{old('audiosummary')}}</textarea>
      ...
      <div class="form-group">
        ...
        <div class="input-group mb-3">
          ...
          <textarea class="form-control" placeholder="Enter Seo Keyword" name="seokeyword">{{old('seotitle')}}</textarea>
          <div class="text text-danger">{{ $errors->first('seokeyword') }}</div>
        </div>
      </div>
      <div class="form-group">
        <label >Seo Description</label>
        <textarea class="textarea form-control" placeholder="Enter Seo Description" name="seodescription">{{old('seotitle')}}</textarea>
