...
<section class="content">
	<div class="row"> 
     ...
     <div class="card card-info">
      ...
      <div class="card-body">
        <form action="{{url('/update_advertisement/'.$advertisement->id)}}" method="post" enctype="multipart/form-data">
         @csrf
         <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="advertisementtitle" value="{{$advertisement['advertisementtitle']}}" placeholder="Enter Advertisement Title" name="newstitle">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="advertisementurl" value="{{$advertisement['advertisementurl']}}" placeholder="Enter Advertisement URL" name="newstitle">
        ...
        <div class="form-group">
          ...
          <div class="text text-danger">{{ $errors->first('advertisementdescription') }}</div>  
                  <div class="form-group">
                    ...
                    <input type="file" name="image" value="{{$advertisement['image']}}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="alternativeadvertisementdescription" value="{{$advertisement['alternativeadvertisementdescription']}}" placeholder="Enter Alternative Advertisement Description" name="Image_title">
                ...
                <div class="input-group mb-3">
                  ...
                  <select class="form-control select2" name="section" value="{{$advertisement['section']}}">
