...
class SeoController extends Controller
{
  ...
  public function store()
  {
   ...
   return redirect('/seo')->with('success','Inserted Successfully');
 }

 public function edit($id)
 {
  $seo = Seo::findorfail($id);
  return view('cd-admin.seo.editseo',compact('seo'));
}
...
public function update($id)
{
 ...
 return redirect('/seo')->with('success','Updated Successfully');
}

public function delete($id)
{
  DB::table('seos')->where('id',$id)->delete();
  return redirect('/seo')->with('error','Deleted Successfully');
}
